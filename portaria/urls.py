...
from . import views
from .views import visitantes_preaprovados_api, get_all_fields, veiculos_unidades
...
path("ajax/responsaveis/<int:unidade_id>/", views.ajax_responsaveis, name="ajax_responsaveis"),
